...
When we learn a new piece of information, our brain can retain it for a small amount of time before it is forgotten. But each time we can recall the information, it takes longer to forget. We have strengthened the neural pathway.
...
<figure markdown="span">
  ![An image of a man walking a dirt pathway through an overgrown field.](../../img/meadow-with-track.webp){ width="600", loading=lazy }
</figure>
